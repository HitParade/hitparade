...
Original source; https://gist.github.com/chenjianjx/53d8c2317f6023dc2fa0

TODO: Send the correct kill signal to the process, as celery is complaining
'''
...
celery_cmdline = 'celery worker -A hitparade.celery -Q default -n default@%h --autoscale=10,3 -l INFO'.split(" ")
